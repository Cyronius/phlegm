...
(C:/caps/m0d/000118.bo @12288, bf16 [2048][256]); fp64 reference."""
...
def main() -> int:
    W = np.fromfile(PACK, np.uint8)[12288:12288 + HID * E * 2].view(bfloat16).reshape(HID, E)
    if CHAIN_XM.is_file():
    ...
    d = "C:/code/phlegm/tools/open-kernels/designs/router"
    cfg = "\n".join([
        "device",
